...
public:
	...
	char dbUser[21], dbPass[64], dbConnStr[128];

	// VAMP - sql connection
	SAConnection con;

	// VAMP - get character char ID
	...
	bool iGetCharacterData(char * cCharName, char * cMapName, short * sAppr1, short * sAppr2, short * sAppr3, short * sAppr4, int * iApprColor, char * cSex, char * cSkin, int * iLevel, DWORD * iExp, int * iStr, int * iVit, int * iDex, int * iInt, int * iMag, int * iCharisma, int * iSaveYear, int * iSaveMonth, int * iSaveDay, int * iSaveHour, int * iSaveMinute);
	...
	bool bInitSQLServer(char* dbUser, char* dbPass, char* dbConn);
