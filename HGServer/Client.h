...
public:
	...
	unsigned long long m_iNextLevelExp;
	BOOL m_bIsKilled;
	...
	unsigned long long   m_iExpStock;			 // 쌓여있는 경험치 
	DWORD m_dwExpStockTime;		 // ExpStock 계산 시간.

	unsigned long long   m_iAutoExpAmount;		 // Auto-Exp 시간 동안 얻은 경험치 
	...
	unsigned long long   m_iSpeedHackCheckExp;
